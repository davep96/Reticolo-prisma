...
\begin{document}
	...
	\section{Introduzione}
		...
		Obbiettivo finale di questo esperimento è quello di determinare l'indice di rifrazione $n$ del vetro di cui è composto un prisma, o, più propriamente di verificare la legge di dispersione di Cauchy qui di seguito

	\begin{equation}\label{Cauchy}
		n^2(\lambda)=a+\frac{b}{\lambda^2}
	\end{equation}

e di calcolarne i parametri.
